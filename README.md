...
[![Build Status](https://travis-ci.org/peterdiaz/openapi-repo.svg?branch=master)](https://travis-ci.org/peterdiaz/openapi-repo)
...
6. If you did everything correct, https://peterdiaz.github.io/openapi-repo/ will lead to your new docs
...
- Documentation(ReDoc): https://peterdiaz.github.io/openapi-repo/
- SwaggerUI: https://peterdiaz.github.io/openapi-repo/swagger-ui/
- Look full spec:
    + JSON https://peterdiaz.github.io/openapi-repo/swagger.json
    + YAML https://peterdiaz.github.io/openapi-repo/swagger.yaml
- Preview spec version for branch `[branch]`: https://peterdiaz.github.io/openapi-repo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://peterdiaz.github.io/openapi-repo/ with url from the message: `Server started <url>`
